...
RUN yum -y install mailx google-authenticator mod_authnz_pam freeradius-utils pam_radius php php-cli certbot python2-certbot-apache httpd cronie inotify-tools; yum clean all 
